...
# This dict is pygame's THECOLORS with addition of
# indigo, lime, olive, silver and teal
col_dict_long = {
...
# An abridged version I put together from internet - a subset of above
col_dict_short = {
    "beige": (245, 245, 220, 255),
    "black": (0, 0, 0, 255),
    "blue": (0, 0, 255, 255),
...
col_dict = col_dict_short if WHICH == "short" else col_dict_long

default_col_name = "white"
default_col = col_dict[default_col_name.lower()]


def col(col_name):
    if not isinstance(col_name, str):
        warnings.warn(f"Colour name must be string! Using {default_col_name} instead.")
        return default_col
    col_name = col_name.lower()
    if col_name not in col_dict:
        warnings.warn(f"{col_name} not found! Using {default_col_name} instead.")
        return default_col
